...
namespace Demo2
{
  public class Game1 : Game
  {
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      spriteBatch.Draw(spriteTexture, Vector2.Zero, color: Color.White);
      spriteBatch.Draw(spriteTexture, new Vector2(100, 0), Color.White);
      spriteBatch.Draw(potatoTexture, destinationRectangle: new Rectangle(0, 0, 500, 500), color: Color.White);
      spriteBatch.End();
