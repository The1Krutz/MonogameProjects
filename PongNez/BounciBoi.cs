...
public class PongScene : Scene
{
  ...
  public override void Initialize()
  {
    ...
    Entity bottomwall = CreateEntity("bottomwall");
    ...
    _scoreboard = new TextComponent(Graphics.Instance.BitmapFont,
                                    ...
                                    new Vector2(0, -5),
                                    Color.White);
    Entity topwall = CreateEntity("topwall", new Vector2(_sceneWidth / 2, 27));
  ...
  {
    BoxCollider ballCollider = _ball.GetComponent<BoxCollider>();
    BoxCollider rightWallCollider = _rightWall.GetComponent<BoxCollider>();
    BoxCollider leftWallCollider = _leftWall.GetComponent<BoxCollider>();
...
public class Paddle : Component, IUpdatable
{
  ...
  {
    Texture2D texture = Entity.Scene.Content.Load<Texture2D>("paddle");
