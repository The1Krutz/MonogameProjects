...
- BopBip - Sample project created in 2026 using Monogame [startup instructions](https://docs.monogame.net/articles/tutorials/building_2d_games/02_getting_started/index.html?tabs=linux). Used it as a template for updating all the older projects.
...
- Monohexa - Some hexagon stuff I never got too deep into
